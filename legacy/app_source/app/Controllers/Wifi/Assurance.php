...
namespace App\Controllers\Wifi;
...
class Assurance extends ResourceController
{
    ...
    public function index()
    {
        ...
        return view('wifi/assurance/index', $data);
    }
    ...
    public function new()
    {
        ...
        return view('wifi/assurance/new', $data);
    }
    ...
    public function create()
    {
        ...
        if (!$this->validate(
            ...
            return redirect()->to('/wifi/assurance/new')->withInput();
        }
        ...
        if (!$file->getError()) {
            ...
            if ($extension == 'xlsx' || $extension == 'xls') {
                ...
                return redirect()->to('/wifi/assurance/new')->with('error', 'Format File Worklogs Tidak Sesuai')->withInput();
            }
        }

        return redirect()->to('/wifi/assurance')->with('success', 'Data berhasil disimpan.');
    }
    ...
    public function edit($id = null)
    {
        ...
        if (is_object($dataAsrwan)) {
            ...
            return view('wifi/assurance/edit', $data);
        } else {
    ...
    public function update($id = null)
    {
        ...
        if (!$this->validate(
            ...
            return redirect()->to('/wifi/assurance/' . $id . '/edit')->withInput();
        }
        ...
        if (!$file->getError()) {
            ...
            if ($extension == 'xlsx' || $extension == 'xls') {
                ...
                return redirect()->to('/wifi/assurance/' . $id . '/edit')->with('error', 'Format File Worklogs Tidak Sesuai')->withInput();
            }
        }

        return redirect()->to('/wifi/assurance')->with('success', 'Data berhasil diupdate.');
    }
    ...
    public function delete($id = null)
    {
        ...
        return redirect()->to('/wifi/assurance')->with('success', 'Data berhasil dihapus.');
    }
    ...
    public function listData()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $db = db_connect();
            $array = ['assurance_wan.deleted_at' => null, 'divisi' => 'wifi'];
            ...
            return DataTable::of($builder)
                ...
                ->add('action', function ($dataAsrwan) {
                    ...
                    <a href=\"/wifi/assurance/$dataAsrwan->idasr/edit\" type=\"button\" class=\"btn btn-sm btn-warning\">
        ...
        if ($this->request->isAJAX()) {
            ...
            return DataTable::of($builder)
                ...
                ->add('action', function ($dataAsrwan) {
                    ...
                    <a href=\"/wifi/assurance/restore/$dataAsrwan->idasr\" type=\"button\" class=\"btn btn-sm btn-info\">
    ...
    public function export()
    {
        ...
        $filename = 'ASSURANCE-wifi-' . date('ymd-his') . '.xlsx';
        ...
        if ($extension == 'xlsx' || $extension == 'xls') {
            ...
            foreach ($dataAsrwan as $d => $value) {
                ...
                $data = [
                    ...
                    'resolved_date'             => $value[68] != null ? date('Y-m-d H:i:s', strtotime($value[68])) : $value[66],
                    'jumlah_site_tsel_nossa'    => $value[69],
                    'kategori_site_tsel'        => $value[70],
    ...
    public function trash()
    {
        ...
        return view('wifi/assurance/trash', $data);
    }
    ...
    public function restore($id = null)
    {
        ...
        if ($this->db->affectedRows() > 0) {
            return redirect()->to('/wifi/assurance')->with('success', 'Data berhasil direstore.');
        }

        return redirect()->to('/wifi/assurance');
    }
    ...
    public function deletetrash($id = null)
    {
        ...
        if ($id != null) {
            ...
            return redirect()->to('/wifi/assurance/trash')->with('success', 'Data berhasil dihapus permanen.');
        } else {
