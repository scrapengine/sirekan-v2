...
class Fulfillment extends ResourceController
{
    ...
    public function index()
    {
        ...
        return view('ccan/fulfillment/index', $data);
    }
    ...
    public function new()
    {
        ...
        return view('ccan/fulfillment/new', $data);
    }
    ...
    public function create()
    {
        ...
        if (!$this->validate(
            ...
            return redirect()->to('/ccan/fulfillment/new')->withInput();
        }
        ...
        return redirect()->to('/ccan/fulfillment')->with('success', 'Data berhasil disimpan.');
    }
    ...
    public function edit($id = null)
    {
        ...
        if (is_object($dataFfwan)) {
            ...
            return view('ccan/fulfillment/edit', $data);
        } else {
    ...
    public function update($id = null)
    {
        ...
        if (!$this->validate(
            ...
            return redirect()->to('/ccan/fulfillment/' . $id . '/edit')->withInput();
        }
        ...
        return redirect()->to('/ccan/fulfillment')->with('success', 'Data berhasil diupdate.');
    }
    ...
    public function delete($id = null)
    {
        ...
        return redirect()->to('/ccan/fulfillment')->with('success', 'Data berhasil dihapus.');
    }
    ...
    public function listData()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $db = db_connect();
            $array = ['ffwan.deleted_at' => null, 'divisi' => 'CCAN'];
            ...
            return DataTable::of($builder)
                ...
                ->add('action', function ($dataFfwan) {
                    ...
                    <a href=\"/ccan/fulfillment/$dataFfwan->idff/edit\" type=\"button\" class=\"btn btn-sm btn-warning\">
        ...
        if ($this->request->isAJAX()) {
            ...
            return DataTable::of($builder)
                ...
                ->add('action', function ($dataFfwan) {
                    ...
                    <a href=\"/ccan/fulfillment/restore/$dataFfwan->idff\" type=\"button\" class=\"btn btn-sm btn-info\">
    ...
    public function trash()
    {
        ...
        return view('ccan/fulfillment/trash', $data);
    }
    ...
    public function restore($id = null)
    {
        ...
        if ($this->db->affectedRows() > 0) {
            return redirect()->to('/ccan/fulfillment')->with('success', 'Data berhasil direstore.');
        }

        return redirect()->to('/ccan/fulfillment');
    }
    ...
    public function deletetrash($id = null)
    {
        ...
        if ($id != null) {
            ...
            return redirect()->to('/ccan/fulfillment/trash')->with('success', 'Data berhasil dihapus permanen.');
        } else {
