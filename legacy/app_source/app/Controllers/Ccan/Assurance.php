...
namespace App\Controllers\Ccan;
...
class Assurance extends ResourceController
{
    ...
    public function index()
    {
        ...
        return view('ccan/assurance/index', $data);
    }
    ...
    public function new()
    {
        ...
        return view('ccan/assurance/new', $data);
    }
    ...
    public function create()
    {
        ...
        if (!$this->validate(
            ...
            return redirect()->to('/ccan/assurance/new')->withInput();
        }
        ...
        if (!$file->getError()) {
            ...
            if ($extension == 'xlsx' || $extension == 'xls') {
                ...
                return redirect()->to('/ccan/assurance/new')->with('error', 'Format File Worklogs Tidak Sesuai')->withInput();
            }
        }

        return redirect()->to('/ccan/assurance')->with('success', 'Data berhasil disimpan.');
    }
    ...
    public function edit($id = null)
    {
        ...
        if (is_object($dataAsrwan)) {
            ...
            return view('ccan/assurance/edit', $data);
        } else {
    ...
    public function update($id = null)
    {
        ...
        if (!$this->validate(
            ...
            return redirect()->to('/ccan/assurance/' . $id . '/edit')->withInput();
        }
        ...
        if (!$file->getError()) {
            ...
            if ($extension == 'xlsx' || $extension == 'xls') {
                ...
                return redirect()->to('/ccan/assurance/' . $id . '/edit')->with('error', 'Format File Worklogs Tidak Sesuai')->withInput();
            }
        }

        return redirect()->to('/ccan/assurance')->with('success', 'Data berhasil diupdate.');
    }
    ...
    public function delete($id = null)
    {
        ...
        return redirect()->to('/ccan/assurance')->with('success', 'Data berhasil dihapus.');
    }
    ...
    public function listData()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $db = db_connect();
            $array = ['assurance_wan.deleted_at' => null, 'divisi' => 'CCAN'];
            ...
            return DataTable::of($builder)
                ...
                ->add('action', function ($dataAsrwan) {
                    ...
                    <a href=\"/ccan/assurance/$dataAsrwan->idasr/edit\" type=\"button\" class=\"btn btn-sm btn-warning\">
        ...
        if ($this->request->isAJAX()) {
            ...
            return DataTable::of($builder)
                ...
                ->add('action', function ($dataAsrwan) {
                    ...
                    <a href=\"/ccan/assurance/restore/$dataAsrwan->idasr\" type=\"button\" class=\"btn btn-sm btn-info\">
    ...
    public function export()
    {
        ...
        $filename = 'ASSURANCE-CCAN-' . date('ymd-his') . '.xlsx';
        ...
        $sheet->setCellValue('E1', 'Owner Group');
        $sheet->setCellValue('F1', 'Owner');
        $sheet->setCellValue('G1', 'External Ticketid');
        $sheet->setCellValue('H1', 'customer Segment');
        $sheet->setCellValue('I1', 'Service No');
        $sheet->setCellValue('J1', 'service type');
        $sheet->setCellValue('K1', 'Reported Date');
        $sheet->setCellValue('L1', 'Lapul');
        $sheet->setCellValue('M1', 'Gaul');
        $sheet->setCellValue('N1', 'TTR Customer');
        ...
        $sheet->setCellValue('U1', 'Pending Reason');
        $sheet->setCellValue('V1', 'Status');
        $sheet->setCellValue('W1', 'Status Date');
        $sheet->setCellValue('X1', 'Resolved By');
        $sheet->setCellValue('Y1', 'Workzone');
        $sheet->setCellValue('Z1', 'Witel');
        $sheet->setCellValue('AA1', 'Regional');
        $sheet->setCellValue('AB1', 'Actual Solution');
        $sheet->setCellValue('AC1', 'Incident Domain');
        $sheet->setCellValue('AD1', 'Resolved Date');
        $sheet->setCellValue('AE1', 'Jumlah Site Tsel Nossa');
        $sheet->setCellValue('AF1', 'kategori Site Tsel');
        $sheet->setCellValue('AG1', 'Impacted Site Tsel');
        ...
        foreach ($dataAsrwan as $d) {
            ...
            $sheet->setCellValue('C' . $coloumn, $d->customer_name);
            $sheet->setCellValue('D' . $coloumn, $d->summary);
            $sheet->setCellValue('E' . $coloumn, $d->owner_group);
            $sheet->setCellValue('F' . $coloumn, $d->owner);
            $sheet->setCellValue('G' . $coloumn, $d->external_ticketid);
            $sheet->setCellValue('H' . $coloumn, $d->customer_segment);
            $sheet->setCellValue('I' . $coloumn, $d->service_no);
            $sheet->setCellValue('J' . $coloumn, $d->service_type);
            $sheet->setCellValue('K' . $coloumn, $d->reported_date);
            $sheet->setCellValue('L' . $coloumn, $d->lapul);
            $sheet->setCellValue('M' . $coloumn, $d->gaul);
            $sheet->setCellValue('N' . $coloumn, $d->ttr_customer);
            ...
            $sheet->setCellValue('U' . $coloumn, $d->pending_reason);
            $sheet->setCellValue('V' . $coloumn, $d->status);
            $sheet->setCellValue('W' . $coloumn, $d->status_date);
            $sheet->setCellValue('X' . $coloumn, $d->resolved_by);
            $sheet->setCellValue('Y' . $coloumn, $d->workzone);
            $sheet->setCellValue('Z' . $coloumn, $d->witel);
            $sheet->setCellValue('AA' . $coloumn, $d->regional);
            $sheet->setCellValue('AB' . $coloumn, $d->actual_solution);
            $sheet->setCellValue('AC' . $coloumn, $d->incident_domain);
            $sheet->setCellValue('AD' . $coloumn, $d->resolved_date);
            $sheet->setCellValue('AE' . $coloumn, $d->jumlah_site_tsel_nossa);
            $sheet->setCellValue('AF' . $coloumn, $d->kategori_site_tsel);
            $sheet->setCellValue('AG' . $coloumn, $d->impacted_site_tsel);
            $coloumn++;
        }
        ...
        $sheet->getStyle('A1:AG1' . ($coloumn - 1))->applyFromArray($styleArray);
            ...
            if ($save_as == "on") {
                ...
                foreach ($dataAsrwan as $d => $value) {
                    ...
                    $data = [
                        ...
                        'ttr_nasional'              => $value[56],
                        'ttr_regional'              => $value[58],
                        'ttr_witel'                 => $value[59],
                        'ttr_mitra'                 => $value[55],
                        'ttr_agent'                 => $value[54],
                        'ttr_pending'               => $value[57],
                        ...
                        'resolved_date'             => $value[63] != null ? date('Y-m-d H:i:s', strtotime($value[63])) : null,
                        // 'jumlah_site_tsel_nossa'    => $value[69],
                        // 'kategori_site_tsel'        => $value[70] == "" ? null : $value[70],
                        // 'impacted_site_tsel'        => $value[71],
                        'divisi'                    => 'WAN',
                    ...
                    if ($value[29] != null) {
                        $array_merge = array_merge($data, array('service_no' => $value[29]));
                        if ($exist) {
                            $this->dataAsrwan->update($id, $array_merge);
                        } else {
                            $this->dataAsrwan->insert($array_merge);
    ...
    public function trash()
    {
        ...
        return view('ccan/assurance/trash', $data);
    }
    ...
    public function restore($id = null)
    {
        ...
        if ($this->db->affectedRows() > 0) {
            return redirect()->to('/ccan/assurance')->with('success', 'Data berhasil direstore.');
        }

        return redirect()->to('/ccan/assurance');
    }
    ...
    public function deletetrash($id = null)
    {
        ...
        if ($id != null) {
            ...
            return redirect()->to('/ccan/assurance/trash')->with('success', 'Data berhasil dihapus permanen.');
        } else {
