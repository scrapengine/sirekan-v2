...
<div class="main-content">
    <section class="section">
        <div class="section-header mb-3 px-3">
            ...
            <div class="font-weight-bold" style="font-size: 1rem;">ADD DATA STO</div>
        </div>
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-body col-md-12 mt-3">
                    <form action="/additional/sto" method="post">
                        <?= csrf_field(); ?>
                        <div class="form-group row">
                            <label for="witel" class="text-md-right col-12 col-md-3 col-lg-3 col-form-label">witel*</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control <?= ($validation->hasError('witel')) ? 'is-invalid' : ''; ?>" id="witel" name="witel" placeholder="witel" value="<?= old('witel'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control <?= ($validation->hasError('idsto')) ? 'is-invalid' : ''; ?>" id="idsto" name="idsto" placeholder="idsto" value="<?= old('idsto'); ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" id="nama_sto" name="nama_sto" placeholder="nama_sto" value="<?= old('nama_sto'); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <textarea type="text" class="form-control" style="height:100%;" id="alamat" name="alamat" placeholder="alamat"><?= old('alamat'); ?></textarea>
                            </div>
                        </div>
