    ...
    <section class="section">
        <div class="section-header mb-3 px-3">
            <div class="section-header-back">
                <a href="<?= base_url('wifi/assurance'); ?> " class="btn btn-sm btn-link"><i class="fas fa-arrow-left"></i></a>
            </div>
...
<script>
    $(document).ready(function() {
        table = $('#assuranceCcanTrash').DataTable({
            ...
            serverSide: true,
            searching: true,
            ajax: "<?php echo site_url('wifi/assurance/listdatatrash') ?>",
            order: [
                [
...
<script>
    ...
    $(document).on('click', '#btnDelete', function(event) {
        ...
        var url = "<?php echo site_url('/wifi/assurance/deletetrash/') ?>" + idasr
    ...
    $(document).on('click', '#btnDeleteAll', function(event) {
        event.preventDefault();
        var url = "<?php echo site_url('/wifi/assurance/deletetrash') ?>"
    ...
    $(document).on('click', '#btnRestoreAll', function(event) {
        event.preventDefault();
        var url = "<?php echo site_url('/wifi/assurance/restore') ?>"
