...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="<?= base_url() ?>/template/node_modules/datatables/datatables.min.css">
    <!-- <link rel="stylesheet" href="<?= base_url() ?>/template/node_modules/datatables/datatables-bs.min.css">
    ...
    <!-- <link rel="stylesheet" href="<?= base_url() ?>/template/node_modules/chart.js/dist/Chart.min.css"> -->
    <!-- <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/dt-1.10.23/datatables.min.css" /> -->
    <?= $this->renderSection('selectric-css'); ?>
    <?= $this->renderSection('select2-css'); ?>
    <?= $this->renderSection('timepicker-css'); ?>
    <?= $this->renderSection('chocolat-css'); ?>
    <?= $this->renderSection('leaflet-css'); ?>
...
<body>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown dropdown-list-toggle" hidden><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle beep"><i class="far fa-envelope"></i></a>
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- <a href="javascript:void(0)" class="dropdown-item bg-light rounded justify-content-center"> Login as
                            ...
                            <a href="<?= base_url(); ?>/user/changePassword/<?= user_id(); ?>" class="dropdown-item has-icon">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2023 <div class="bullet"></div> Made with <i class="fas fa-heart"></i> and some <i class="fas fa-mug-hot"></i>
                </div>
    ...
    <?= $this->renderSection('selectric-js'); ?>
    <?= $this->renderSection('swal-js'); ?>
    <?= $this->renderSection('select2-js'); ?>
    <?= $this->renderSection('timepicker-js'); ?>
    <?= $this->renderSection('chocolat-js'); ?>
    <?= $this->renderSection('leaflet-js'); ?>
