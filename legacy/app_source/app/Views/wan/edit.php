        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Update Data Dummy</h4>
                </div>
                <div class="card-body col-md-6">
                    <form action="<?= site_url('wan/' . $gawe->gawe_id); ?>" method="post" autocomplete="off">
                        <?= csrf_field() ?>
                        <input type="hidden" name="_method" value="PUT">
                        <div class="form-group">
                            <label>Name Gawe*</label>
                            <input type="text" name="gawe_name" value="<?= $gawe->gawe_name; ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
