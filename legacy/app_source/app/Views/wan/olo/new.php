...
<div class="main-content">
    <section class="section">
        <div class="section-header mb-3">
            ...
            <div class="font-weight-bold" style="font-size: 1rem;">ADD DATA OLO</div>
        </div>
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-body col-md-12">
                    <form action="/wan/olo" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                                                ...
                                                <div class="form-group row mb-0">
                                                    <div class="form-row col-12 col-lg-12">
                                                        <div class="form-group col-lg-6 col-sm-12">
                                                            ...
                                                            <select class="form-control custom-select <?= ($validation->hasError('idsto')) ? 'is-invalid' : ''; ?>" id="idsto" name="idsto" placeholder="idsto" value="<?= old('idsto'); ?>" required>
                                                ...
                                                <div class="form-group row mb-0">
                                                    <div class="form-row col-12 col-lg-12">
                                                        <div class="form-group col-lg-6 col-sm-12">
                                                            ...
                                                            <input type="text" class="form-control <?= ($validation->hasError('no_order')) ? 'is-invalid' : ''; ?>" id="service_id" name="service_id" placeholder="service_id" value="<?= old('service_id'); ?>" required>
                                                            <div class="invalid-feedback">
