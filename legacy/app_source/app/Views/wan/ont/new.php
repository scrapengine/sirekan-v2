...
<div class="main-content">
    <section class="section">
        <div class="section-header mb-3">
            ...
            <div class="font-weight-bold" style="font-size: 1rem;">ADD DATA ONT</div>
        </div>
        <!-- alert -->
        <?php if ($validation->hasError('serial_number')) : ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Error! </strong> <?= $validation->getError('serial_number'); ?>
        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-body mt-3 col-md-12">
                    <form action="/wan/ont" method="post" id="submitOnt">
                        <?= csrf_field(); ?>
                        <!-- <div class="form-group row">
                            <label for="merk" class="text-md-right col-12 col-md-3 col-lg-3 col-form-label">Merk</label>
                            <div class="col-sm-12 col-md-7">
                                <select class="form-control custom-select" id="merk" name="merk" placeholder="merk" value="<?= old('merk'); ?>">
                                    <option value="" hidden>Choose...</option>
                                    <?php foreach ($ontMerk as $d) : ?>
                                        <option value="<?= old('merk'); ?>" hidden <?= old('merk') == $d->merk ? 'selected' : null ?>><?= old('merk'); ?></option>
                                    ...
                                    <div class="input-group">
                                        <select class="form-control custom-select" id="ont_type" name="ont_type" placeholder="ont_type" value="<?= old('ont_type'); ?>">
                                            ...
                                            <?php foreach ($ontType as $d) : ?>
                                                <option value="<?= old('ont_type'); ?>" hidden <?= old('ont_type') == $d->merk . "-" . $d->type ? 'selected' : null ?>><?= old('ont_type'); ?></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control tagsinput <?= ($validation->hasError('serial_number')) ? 'is-invalid' : ''; ?>" data-role="tagsinput" id="serial_number" name="serial_number" placeholder="serial_number" value="<?= old('serial_number'); ?>" />
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-check form-check-radio form-check-inline ml-3">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="status" id="status1" value="BAIK" <?= (old('status') == 'BAIK') ? 'checked' : ''; ?>>
                                    BAIK
                                    <span class="form-check-sign"></span>
                                </label>
                            </div>
                            <div class="form-check form-check-radio form-check-inline ml-1">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="status" id="status2" value="RUSAK" <?= (old('status') == 'RUSAK') ? 'checked' : ''; ?>>
                                    RUSAK
                                    <span class="form-check-sign"></span>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-check form-check-radio form-check-inline ml-3">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="allocation" id="allocation1" value="ASSURANCE" <?= (old('allocation') == 'ASSURANCE') ? 'checked' : ''; ?>>
                                    ASSURANCE
                                    <span class="form-check-sign"></span>
                                </label>
                            </div>
                            <div class="form-check form-check-radio form-check-inline ml-1">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="allocation" id="allocation2" value="FULFILLMENT" <?= (old('allocation') == 'FULFILLMENT') ? 'checked' : ''; ?>>
                                    FULFILLMENT
                                    <span class="form-check-sign"></span>
                                </label>
                            </div>
                            <div class="form-check form-check-radio form-check-inline ml-1">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="allocation" id="allocation3" value="OLO" <?= (old('allocation') == 'OLO') ? 'checked' : ''; ?>>
                                    OLO
                                    <span class="form-check-sign"></span>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="date" class="form-control" id="received" name="received" placeholder="received" value="<?= old('received', "hh-bb-tttt"); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="installed" class="text-md-right col-12 col-md-3 col-lg-3 col-form-label">Installed</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="date" class="form-control" id="installed" name="installed" placeholder="installed" value="<?= old('installed'); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="return" class="text-md-right col-12 col-md-3 col-lg-3 col-form-label">Return</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="date" class="form-control" id="return" name="return" placeholder="return" value="<?= old('return', null); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="desc" class="text-md-right col-12 col-md-3 col-lg-3 col-form-label">Desc</label>
                            <div class="col-sm-12 col-md-7">
                                <textarea type="text" class="form-control" style="height: 100%;" id="desc" name="desc" placeholder="desc"><?= old('desc'); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4 mt-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
                            <div class="col-sm-12 col-md-7">
                                <button type="button" class="btn btn-primary" onclick="submitForm()"><i class="fas fa-server"></i> Save</button>
...
<script>
    function submitForm() {
        document.getElementById("submitOnt").submit();
    }
