        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-body col-md-12">
                    <form action="/wan/nodeb" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                                                ...
                                                <div class="form-group row mb-0">
                                                    <div class="form-row col-12 col-lg-12">
                                                        ...
                                                        <div class="form-group col-lg-6 col-sm-12">
                                                            ...
                                                            <input type="date" class="form-control" id="on_air" name="on_air" placeholder="on_air" value="<?= old('on_air'); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-lg-12">
                                                        <input type="text" class="form-control" id="graph_id" name="graph_id" placeholder="graph_id" value="<?= old('graph_id'); ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
