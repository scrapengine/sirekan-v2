...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Data NODE-B</h1>
    <div class="col-10">
        <div class="card shadow mb-4">
            <div class="card-header py-3"></div>
            <div class="card-body">
                <form action="/wan/save" method="post">
                    <?= csrf_field(); ?>
                    <div class="form-group row">
                        <label for="sto" class="col-sm-2 col-form-label">STO</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="sto" name="sto" placeholder="STO" autofocus value="<?= old('sto'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="site_id" class="col-sm-2 col-form-label">site_id</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('site_id')) ? 'is-invalid' : ''; ?>" id="site_id" name="site_id" placeholder="site_id" value="<?= old('site_id'); ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="site_name" name="site_name" placeholder="site_name" value="<?= old('site_name'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="hostname_metro" class="col-sm-2 col-form-label">hostname_metro</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="hostname_metro" name="hostname_metro" placeholder="hostname_metro" value="<?= old('hostname_metro'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="hostname_gpon" name="hostname_gpon" placeholder="hostname_gpon" value="<?= old('hostname_gpon'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="ip_gpon" class="col-sm-2 col-form-label">ip_gpon</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="ip_gpon" name="ip_gpon" placeholder="ip_gpon" value="<?= old('ip_gpon'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="port_gpon" class="col-sm-2 col-form-label">port_gpon</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="port_gpon" name="port_gpon" placeholder="port_gpon" value="<?= old('port_gpon'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="port_ont" name="port_ont" placeholder="port_ont" value="<?= old('port_ont'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="tikor_site" name="tikor_site" placeholder="tikor_site" value="<?= old('tikor_site'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10">
