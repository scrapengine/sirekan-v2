                                                ...
                                                <div class="form-group row mb-0">
                                                    <div class="form-row col-12 col-lg-12">
                                                        ...
                                                        <div class="form-group col-lg-4 col-sm-12">
                                                            ...
                                                            <input type="date" class="form-control" id="tanggal_install" name="tanggal_install" placeholder="tanggal_install" value="<?= old('tanggal_install'); ?>">
                                                        </div>
                                                        <div class="form-group col-lg-4 col-sm-12">
                                                            <label for="tanggal_ps">TANGGAL_PS</label>
                                                            <input type="date" class="form-control" id="tanggal_ps" name="tanggal_ps" placeholder="tanggal_ps" value="<?= old('tanggal_ps'); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-0">
                                                    ...
                                                    <div class="form-row col-12 col-lg-12">
                                                        ...
                                                        <div class="form-group col-lg-6 col-sm-12">
                                                            ...
                                                            <select class="form-control custom-select" id="order_type" name="order_type" placeholder="order_type" value="<?= old('order_type'); ?>">
                                                                <option value="" hidden>Choose...</option>
                                                                <option value="New Install" <?= (old('order_type') == 'New Install') ? 'selected' : ''; ?>>New Install</option>
                                                                <option value="Modify" <?= (old('order_type') == 'Modify') ? 'selected' : ''; ?>>Modify</option>
                                                                <option value="Disconnect" <?= (old('order_type') == 'Disconnect') ? 'selected' : ''; ?>>Disconnect</option>
                                                                <option value="Suspend" <?= (old('order_type') == 'Suspend') ? 'selected' : ''; ?>>Suspend</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-0">
                                                    <div class="form-row col-12 col-lg-12">
                                                        ...
                                                        <div class="form-group col-lg-6 col-sm-12">
                                                            ...
                                                            <input type="number" step="any" class="form-control" id="lan" name="lan" placeholder="Meter" value="<?= old('lan'); ?>">
                                                        </div>
                                                    </div>
                                                </div>
