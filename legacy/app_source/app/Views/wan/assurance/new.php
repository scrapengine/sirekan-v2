                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="ticket" role="tabpanel" aria-labelledby="ticket-tab">
                            <div class="card-body col-md-12 pt-0">
                                <form action="/wan/assurance" method="post" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2 col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="ttr_end_to_end" id="ttr_end_to_end" class=" form-control bg-white" value="<?= old('ttr_end_to_end'); ?>">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="jumlah_site_tsel_nossa" id="Jumlah_Site_Tsel_Nossa" class="form_edit form-control bg-white" value="<?= old('Jumlah_Site_Tsel_Nossa'); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control custom-select" id="kategori_site_tsel" name="kategori_site_tsel" placeholder="kategori_site_tsel" value="<?= old('kategori_site_tsel'); ?>">
                                                                            <option value="" hidden>Choose...</option>
                                                                            <option value="CANCEL" <?= (old('kategori_site_tsel') == 'CANCEL') ? 'selected' : ''; ?>>CANCEL</option>
                                                                            <option value="DOUBLE" <?= (old('kategori_site_tsel') == 'DOUBLE') ? 'selected' : ''; ?>>DOUBLE</option>
                                                                            <option value="DOWN" <?= (old('kategori_site_tsel') == 'DOWN') ? 'selected' : ''; ?>>DOWN</option>
                                                                            <option value="PARTIAL" <?= (old('kategori_site_tsel') == 'PARTIAL') ? 'selected' : ''; ?>>PARTIAL</option>
                                                                            <option value="PREMIUM SITE" <?= (old('kategori_site_tsel') == 'PREMIUM SITE') ? 'selected' : ''; ?>>PREMIUM SITE</option>
                                                                            <option value="PREVENTIVE" <?= (old('kategori_site_tsel') == 'PREVENTIVE') ? 'selected' : ''; ?>>PREVENTIVE</option>
                                                                            <option value="QUALITY" <?= (old('kategori_site_tsel') == 'QUALITY') ? 'selected' : ''; ?>>QUALITY</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea id="impacted_site" id="impacted_site" class="form-control bg-white" style="height: 200px !important; width: 100% !important"><?= old('impacted_site'); ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
