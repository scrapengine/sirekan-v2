    ...
    <section class="section">
        <div class="section-header mb-3 px-3">
            <div class="section-header-back">
                <a href="<?= base_url('wan/assurance'); ?> " class="btn btn-sm btn-link"><i class="fas fa-arrow-left"></i></a>
            </div>
        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-body col-md-12">
                    <form action="/wan/assurance/<?= $dataAsrwan->idasr; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                                        ...
                                        <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2 col-sm-12">
                                                        <div class="form-group">
                                                            <label class="" for="">TTR_End_to_End</label>
                                                            <input type="text" name="ttr_end_to_end" id="ttr_end_to_end" class=" form-control bg-white" value="<?= old('ttr_end_to_end', $dataAsrwan->ttr_end_to_end); ?>">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-sm-12">
                                                        <div class="form-group">
                                                            <label for="">Jumlah_Site_Tsel_Nossa</label>
                                                            <input type="text" name="jumlah_site_tsel_nossa" id="jumlah_site_tsel_nossa" class="form_edit form-control bg-white" value="<?= old('jumlah_site_tsel_nossa', $dataAsrwan->jumlah_site_tsel_nossa); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-sm-12">
                                                        <div class="form-group">
                                                            <label for="">Kategori_Site_Tsel</label>
                                                            <select class="form-control custom-select" id="kategori_site_tsel" name="kategori_site_tsel" placeholder="kategori_site_tsel" value="<?= old('kategori_site_tsel'); ?>">
                                                                <option value="" hidden>Choose...</option>
                                                                <option value="CANCEL" <?= (old('kategori_site_tsel', $dataAsrwan->kategori_site_tsel) == 'CANCEL') ? 'selected' : ''; ?>>CANCEL</option>
                                                                <option value="DOUBLE" <?= (old('kategori_site_tsel', $dataAsrwan->kategori_site_tsel) == 'DOUBLE') ? 'selected' : ''; ?>>DOUBLE</option>
                                                                <option value="DOWN" <?= (old('kategori_site_tsel', $dataAsrwan->kategori_site_tsel) == 'DOWN') ? 'selected' : ''; ?>>DOWN</option>
                                                                <option value="PARTIAL" <?= (old('kategori_site_tsel', $dataAsrwan->kategori_site_tsel) == 'PARTIAL') ? 'selected' : ''; ?>>PARTIAL</option>
                                                                <option value="PREMIUM SITE" <?= (old('kategori_site_tsel', $dataAsrwan->kategori_site_tsel) == 'PREMIUM SITE') ? 'selected' : ''; ?>>PREMIUM SITE</option>
                                                                <option value="PREVENTIVE" <?= (old('kategori_site_tsel', $dataAsrwan->kategori_site_tsel) == 'PREVENTIVE') ? 'selected' : ''; ?>>PREVENTIVE</option>
                                                                <option value="QUALITY" <?= (old('kategori_site_tsel', $dataAsrwan->kategori_site_tsel) == 'QUALITY') ? 'selected' : ''; ?>>QUALITY</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="">Impacted_Site</label><br>
                                                            <textarea id="impacted_site_tsel" id="impacted_site_tsel" class="form-control bg-white" style="height: 200px !important; width: 100% !important"><?= old('impacted_site_tsel', $dataAsrwan->impacted_site_tsel); ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
